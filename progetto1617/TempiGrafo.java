...
public class TempiGrafo{
	...
	public static Grafo preparaDNA(RandomGenerator rg, int sequenze) {
		...
		for(int i = 0; i<parole.length; i++){
			Main.inserisciNodi(parole[i], l);
		}
		/*GENERAZIONE ARCHI*/
	   
	    char[] calfabeto = Alfabeto.charalfabeto(alfabeto); 
	    Main.generaArchi(l, calfabeto);
